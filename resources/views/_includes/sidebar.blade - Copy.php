		...
		<div id="sidebar-menu" class="sidebar-menu">
			...
			<ul class="sidebar-vertical">
				...
				<li class="{{ request()->routeIs('dashboard') ? 'active' : '' }}">
					<a href="{{ route('dashboard')}}"><i class="la la-dashcube"></i> <span> {{ __('dashboard') }} </span></a>
				</li>
				{{--<li class="{{ request()->routeIs('user.contact','user.contact-grid','user.contact.preview') ? 'active' : '' }}">
					<a href="{{ route('user.contact') }}"><i class="la la-user-shield"></i> <span> {{ __('contact') }} </span></a>
				</li>--}}
				<li class="submenu">
					<a href="javascript:void(0);"><i class="la la-share-alt"></i> <span>{{ __('masters') }}</span> <span class="menu-arrow"></span></a>
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);"> <span>Level 1</span> <span class="menu-arrow"></span></a>
							<ul>
