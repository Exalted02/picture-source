		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="success-message text-center">
					...
					<p>{{ __('artist') }} "<span id="list_name"></span>" {{ __('from_your_account') }}</p>
...
<!-- Add product code -->
<div id="add_artist" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">{{ __('add_new_artist') }}</h5>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="input-block mb-3">
								...
								<div class="invalid-feedback">{{ __('please_enter') }} {{ __('artist')}}.</div>
							</div>
						</div>
					</div>
...
{{--<div id="edit_product_code" class="modal custom-modal fade" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">{{ __('edit_new_artist') }}</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			<div class="modal-body">
				<form id="frmeditproductcode" action="{{ route('user.save-artist') }}">
				<input type="hidden" id="id" name="id">
					<div class="row">
						<div class="col-sm-12">
							<div class="input-block mb-3">
