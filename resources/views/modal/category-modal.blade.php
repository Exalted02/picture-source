		...
		<div class="modal-content">
			<div class="modal-body">
				<div class="success-message text-center">
					...
					<p>{{ __('category') }} "<span id="list_name"></span>" {{ __('from_your_account') }}</p>
					<div class="col-lg-12 text-center form-wizard-button">
						<a href="#" class="button btn-lights" data-bs-dismiss="modal">{{ __('not_now') }}</a>
						<a href="javascript:void(0);" class="btn btn-primary data-id-pcode-list" data-url="{{ route('deleteCategoryList') }}">{{ __('okay') }}</a>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">{{ __('add_new_category') }}</h5>
