				...
				<div class="col-md-12">
						...
						<div class="row align-items-center">
							<div class="col-sm-6">
								<ul class="contact-breadcrumb">
									<li><a href="{{ route('user.contact-grid')}}"><i class="las la-arrow-left"></i> Contacts</a></li>
					...
					<div class="contact-wrap">
						...
						{{--<div class="avatar avatar-xxl">									
							...
							<div class="name-user">
								<h4>{{ ucfirst($contacts[0]->name) ?? '' }}</h4>
								<p>{{ $add_type ?? ''}}, {{ $contacts[0]->company }}</p>
						...
						{{--<a href="#" class="btn-icon text-warning"><i class="fa-solid fa-star"></i></a>
							...
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a class="dropdown-item delete-contact" href="javascript:void(0);" data-id="{{ $contacts[0]->id ?? '' }}" data-url="{{ route('getDeleteContactName') }}">Delete</a>
								</div>
							</div>
						</div>	
					</div>
					...
					<div class="card contact-sidebar">
						...
						<ul class="basic-info">
							...
							<li>
								...
								<p>{{$contacts[0]->nr ?? '' }},{{$contacts[0]->street ?? '' }},{{$contacts[0]->city ?? '' }}, {{$contacts[0]->zip ?? '' }},{{$contacts[0]->get_state->state_name ?? '' }}, {{$contacts[0]->get_country->country_name ?? ''}}</p>
							</li>
							<li>
								<span>
						...
						<ul class="other-info">
							<li><span class="other-title">Phone</span><span>{{ $contacts[0]->privatephone ?? ''}}</span></li>
							<li><span class="other-title">Mobile</span><span>{{ $contacts[0]->privatemobile ?? ''}}</span></li>
							<li><span class="other-title">Email</span><span>{{ $contacts[0]->privateemail ?? ''}}</span></li>
							<li><span class="other-title">Website</span><span>{{ $contacts[0]->privatewebsite ?? ''}}</span></li>
						</ul>
						<h5>Company</h5>
						<ul class="other-info">
							<li><span class="other-title">Phone</span><span>{{ $contacts[0]->phone ?? ''}}</span></li>
							<li><span class="other-title">Mobile</span><span>{{ $contacts[0]->mobile ?? ''}}</span></li>
							<li><span class="other-title">Email</span><span>{{ $contacts[0]->email ?? ''}}</span></li>
							<li><span class="other-title">Website</span><span>{{ $contacts[0]->website ?? ''}}</span></li>
						</ul>						
						...
						{{--<li><span class="other-title">Language</span><span>Language</span></li>
							...
							<li><span class="other-title">Last Modified</span><span>{{$contacts[0]->updated_at->format('j M Y, h:i a') ?? ''}}</span></li>
